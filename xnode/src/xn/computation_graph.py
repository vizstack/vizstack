...
class _FunctionCall:
    ...
    @staticmethod
    def _create_input_list(input_tuples: List[Tuple[str, Union[List['GraphData'], 'GraphData']]]) -> List['GraphData']:
...
def _make_tracked_arg_list(args: Iterable[Any], arg_names: List[str]) -> List[Tuple[str, Union[List['GraphData'],
                                                                                       'GraphData']]]:
