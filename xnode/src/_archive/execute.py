...
import traceback
import xnode_old
from xnode_old import VizTableSlice, VizId, ExpansionMode, ExecutionEngineMessage
from xnode_old.viz import VisualizationEngine
from xnode_old.viz import Text, Color
...
def run_script(receive_queue: Queue, send_queue: Queue, script_path: str, script_args: List[str]) -> None:
    ...
    xnode_old.set_show_fn(functools.partial(_execute_watch, send_message, engine))
